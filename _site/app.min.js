...
(function () {
  ...
  var data = {
    ...
    timezone: "Asia/Seoul",
    title: "One",
    tagline: "One's DevBlog",
    description:
      "A minimal, responsive and feature-rich Jekyll theme for technical writing.",
    url: "https://yewonkim301.github.io",
    github: { username: "yewonkim301" },
    twitter: { username: "yeowne301" },
    social: {
      name: "Yewon Kim",
      email: "yeowne301@gmail.com",
      links: ["https://x.com/yeowne301", "https://github.com/yewonkim301"]
    },
    ...
    analytics: {
      google: { id: null },
      goatcounter: { id: null },
      umami: { id: null, domain: null },
      matomo: { id: null, domain: null },
      cloudflare: { id: null }
    },
    pageviews: { provider: null },
    theme_mode: null,
    cdn: "https://chirpy-img.netlify.app",
    avatar: "assets/img/snoopy.jpg",
    social_preview_image: null,
    toc: true,
    comments: {
      provider: null,
      disqus: { shortname: null },
      utterances: { repo: null, issue_term: null },
      giscus: {
        repo: null,
        repo_id: null,
        category: null,
    ...
    assets: { self_host: { enabled: null, env: null } },
    pwa: { enabled: true, cache: { enabled: true, deny_paths: null } },
    paginate: 10,
    baseurl: "",
    kramdown: {
      footnote_backlink: "&#8617;&#xfe0e;",
      ...
      syntax_highlighter_opts: {
        ...
        block: { line_numbers: true, start_line: 1 }
      }
    },
    collections: {
      tabs: { output: true, sort_by: "order" },
      app: { output: true, permalink: "/:name" }
    },
    defaults: [
      {
      ...
      { scope: { path: "_drafts" }, values: { comments: false } },
      {
    ...
    "jekyll-archives": {
      ...
      layouts: { category: "category", tag: "tag" },
  ...
  const SelectorEngine = {
    ...
    focusableChildren(element) {
      const focusables = [
        ...
        .map((selector) => "".concat(selector, ':not([tabindex^="-"])'))
        .join(",");
